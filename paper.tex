...
\rulemajor{Make lessons modular}
...
which are easier if lessons clearly define what they cover (Rule~1),
and if lessons have been designed by people with a shared world-view (Rule~3).
...
Smaller modules are also more approachable for new contributors (Rule~4).
...
Unfortunately,
many college and university faculty have little or no training in education \cite{browning2012},
...
A key part of doing this is to create opportunities for legitimate peripheral participation \cite{FIXME}.
...
These often relate to the difficulty lesson developers may have
fully understanding the frame of reference of their audience,
e.g.,
assuming prior knowledge that learners do not have.
If possible,
post-class surveys should be conducted 30--60 days after class.
