...
such as learnr (\texttt{https://rstudio.github.io/learnr}),
Morea (\texttt{https://morea-framework.github.io}),
and DataCamp's templates (\texttt{https://www.datacamp.com/teach/documentation}).
...
One is to give releases DOIs supplied by providers such as Zenodo (\texttt{https://zenodo.org/})
or DataCite (\texttt{https://www.datacite.org/}).
...
names (and identifiers such as ORCIDs (\texttt{https://orcid.org}))
...
\newblock \texttt{https://zenodo.org/record/57571\#.WS8huDOZPdQ}.
...
\newblock \texttt{https://zenodo.org/record/27355\#.WS8lajOZPdQ}.

\bibitem{shell2017}
Devenyi G.~A. and Srinath A. (eds.):
Software Carpentry: The Unix Shell; 2017.
\newblock \texttt{https://zenodo.org/record/278226\#.WS74tTOZPdQ}.

\bibitem{choral-explanations}
Caulfield M. Choral Explanations; 2016.
\newblock \texttt{https://hapgood.us/2016/05/13/choral-explanations/}.
...
\newblock \texttt{http://get.gitlab.com/global-developer-survey/}, 2016.
...
\newblock 64(3),
\newblock 2016,
\newblock https://doi.org/10.5408/15-101.1
