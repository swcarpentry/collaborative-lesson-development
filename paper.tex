...
to publish lessons with a DOI supplied by providers such as Zenodo\footnote{\url{https://zenodo.org/}} or DataCite\footnote{\url{https://zenodo.org/}}.
...
Refering back to Rule~1, it can sometimes be difficult for lesson developers to understand the frame of a given learner
